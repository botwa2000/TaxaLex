...
export const FAQS: FAQData[] = [
  ...
  // ─ pricing ─
  {
    ...
    answer: 'TaxaLex bietet flexible Preismodelle: Einzelfall (5,99 €), 5er-Paket (19,99 € für alle fünf), Monatsflat für Privatpersonen (9,99 €/Monat) und Selbstständigen-Flat (19,99 €/Monat). Optional: Prüfung durch einen Steuerberater oder Anwalt als Zubuchung für 49 € pro Fall. Die aktuelle Preisübersicht finden Sie auf der Preisseite.',
    sortOrder: 1,
  },
  {
    locale: 'en',
    ...
    answer: 'TaxaLex offers flexible pricing: Single case (€5.99), 5-pack (€19.99 for all five), monthly flat for individuals (€9.99/month), and self-employed flat (€19.99/month). Optional: add professional review by a tax advisor or lawyer for €49 per case. See the current pricing overview on the pricing page.',
    sortOrder: 1,
  },
  {
    locale: 'de',
  ...
  // ─ advisor ─
  {
    ...
    answer: 'Ja. Als optionale Zubuchung (49 € pro Fall) können Sie nach der KI-Generierung eine Prüfung durch einen zugelassenen Steuerberater oder Rechtsanwalt beauftragen. Der Fachmann erhält einen sicheren Link, prüft den Entwurf und gibt Feedback oder gibt ihn direkt frei — ohne dass Sie dafür in eine Kanzlei müssen.',
    sortOrder: 1,
  },
  {
    locale: 'en',
    ...
    answer: 'Yes. As an optional add-on (€49 per case), you can request a review by a licensed tax advisor or lawyer after the AI generation. The professional receives a secure link, reviews the draft and either approves it or sends comments — no appointment needed.',
    sortOrder: 1,
  },
  {
    locale: 'de',
