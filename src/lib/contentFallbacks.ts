...
export const USE_CASES: UseCaseData[] = [
  ...
  // ─ Jobcenter / Bürgergeld ─
  {
    ...
    description: 'Jobcenter-Bescheide über Ablehnung, Kürzung oder Streichung von Bürgergeld-Leistungen können angefochten werden. Der Widerspruch ist kostenlos (§ 184 SGG) und muss innerhalb eines Monats eingelegt werden. TaxaLex generiert ein rechtssicheres Widerspruchsschreiben, das auf die spezifischen Fehler im Bescheid eingeht.',
    deadlineText: '1 Monat nach Bekanntgabe',
    deadlineDays: 30,
    legalBasis: '§ 78 SGG',
    successRate: '42 %',
  ...
  },
  {
    ...
    description: 'Jobcenter decisions on rejection, reduction, or withdrawal of Bürgergeld benefits can be challenged. The objection is free of charge (§ 184 SGG) and must be filed within one month. TaxaLex generates a legally sound objection letter addressing the specific errors in the notice.',
    deadlineText: '1 month after notification',
    deadlineDays: 30,
    legalBasis: '§ 78 SGG',
    successRate: '42 %',
  ...
  },
  {
    ...
    description: 'Landlords can only increase rent under strict legal conditions. Increases above the local reference rent (Mietspiegel), incorrect ancillary cost statements, or too-frequent increases can be challenged. TaxaLex generates a legally sound objection letter.',
...
export const FAQS: FAQData[] = [
  ...
  },
  {
    ...
    answer: 'TaxaLex is an AI-powered platform that helps you create professional objection letters against official government notices. Our multi-AI pipeline analyses your notice and generates a legally sound letter in minutes.',
    sortOrder: 1,
  },
  {
    locale: 'de',
    category: 'general',
    question: 'Ist der generierte Einspruch rechtlich bindend?',
    answer: 'Der von TaxaLex generierte Einspruch ist ein professionell formulierter Entwurf, der alle relevanten Rechtsgrundlagen enthält. Er stellt jedoch keine Rechtsberatung im Sinne des Rechtsdienstleistungsgesetzes (RDG) dar. Bei komplexen Fällen empfehlen wir, den Entwurf von einem Steuerberater oder Rechtsanwalt prüfen zu lassen.',
    sortOrder: 2,
  },
  {
    locale: 'en',
    category: 'general',
    question: 'Is the generated objection legally binding?',
    answer: 'The objection generated by TaxaLex is a professionally worded draft that includes all relevant legal bases. However, it does not constitute legal advice within the meaning of the German Legal Services Act (RDG). For complex cases, we recommend having the draft reviewed by a tax advisor or lawyer.',
    sortOrder: 2,
  },
  {
    locale: 'de',
  ...
  // ─ pricing ─
  {
    ...
    answer: 'TaxaLex bietet flexible Preismodelle: Einzelfall (5,99 € pro Einspruch), 5er-Paket (19,99 €), Monatsflat für Privatpersonen (9,99 €/Monat), Selbstständigen-Flat (19,99 €/Monat) sowie Beraterpläne ab 49 €/Monat. Die aktuelle Preisübersicht finden Sie auf der Preisseite.',
    sortOrder: 1,
  },
  {
    locale: 'en',
    ...
    answer: 'TaxaLex offers flexible pricing: Single case (€5.99 per objection), 5-pack (€19.99), monthly flat for individuals (€9.99/month), self-employed flat (€19.99/month), and advisor plans from €49/month. See the current pricing overview on the pricing page.',
    sortOrder: 1,
  },
  {
    locale: 'de',
  ...
  // ─ advisor ─
  {
    locale: 'de',
    category: 'advisor',
    question: 'Wie funktioniert TaxaLex für Steuerberater?',
    answer: 'Steuerberater erhalten Zugang zum Berater-Portal mit Mandanten-Übersicht, Multi-Fall-Management und White-Label-Optionen. Sie können Einsprüche für alle Ihre Mandanten zentral verwalten und die KI-generierten Entwürfe vor dem Versand prüfen und anpassen.',
    sortOrder: 1,
  },
  {
    locale: 'en',
    category: 'advisor',
    question: 'How does TaxaLex work for tax advisors?',
    answer: 'Tax advisors get access to the advisor portal with client overview, multi-case management, and white-label options. You can centrally manage objections for all your clients and review and customise AI-generated drafts before sending.',
    sortOrder: 1,
  },
  {
    locale: 'de',
    category: 'advisor',
    question: 'Gibt es eine DATEV-Anbindung?',
    answer: 'Eine DATEV-Schnittstelle ist in der Roadmap geplant. Aktuell können Sie Fälle und Dokumente manuell importieren. Kontaktieren Sie uns für eine individuelle Integrationslösung.',
    sortOrder: 2,
  },
  {
    locale: 'en',
    category: 'advisor',
    question: 'Is there a DATEV integration?',
    answer: 'A DATEV interface is planned on the roadmap. Currently, you can manually import cases and documents. Contact us for a custom integration solution.',
    sortOrder: 2,
  },
]
...
export const PRICING_PLANS: PricingPlanData[] = [
  {
    ...
    features: [
      ...
      { locale: 'de', text: 'PDF- & TXT-Download', included: true, sortOrder: 3 },
      { locale: 'de', text: '5 KI-Agenten (Multi-LLM)', included: true, sortOrder: 4 },
      { locale: 'de', text: 'Frist-Erinnerungen', included: false, sortOrder: 5 },
      { locale: 'de', text: 'Dokumenten-Archiv', included: false, sortOrder: 6 },
      { locale: 'en', text: '1 complete objection', included: true, sortOrder: 1 },
      { locale: 'en', text: 'All notice types', included: true, sortOrder: 2 },
      { locale: 'en', text: 'PDF & TXT download', included: true, sortOrder: 3 },
      { locale: 'en', text: '5 AI agents (Multi-LLM)', included: true, sortOrder: 4 },
      { locale: 'en', text: 'Deadline reminders', included: false, sortOrder: 5 },
      { locale: 'en', text: 'Document archive', included: false, sortOrder: 6 },
    ],
  },
  {
    ...
    isActive: true,
    translations: {
      de: { locale: 'de', name: '5er-Paket', description: 'Für Haushalte und Selbstständige mit mehreren Bescheiden.', cta: '5er-Paket kaufen' },
      en: { locale: 'en', name: '5-pack', description: 'For households and freelancers with multiple notices.', cta: 'Buy 5-pack' },
    },
    features: [
      { locale: 'de', text: '5 Einsprüche (kein Ablaufdatum)', included: true, sortOrder: 1 },
      { locale: 'de', text: 'Alle Bescheid-Typen', included: true, sortOrder: 2 },
      { locale: 'de', text: 'PDF- & TXT-Download', included: true, sortOrder: 3 },
      { locale: 'de', text: 'Frist-Erinnerungen per E-Mail', included: true, sortOrder: 4 },
      { locale: 'de', text: 'Dokumenten-Archiv', included: true, sortOrder: 5 },
      { locale: 'de', text: 'Mandanten-Verwaltung', included: false, sortOrder: 6 },
      { locale: 'en', text: '5 objections (no expiry)', included: true, sortOrder: 1 },
      { locale: 'en', text: 'All notice types', included: true, sortOrder: 2 },
      { locale: 'en', text: 'PDF & TXT download', included: true, sortOrder: 3 },
      { locale: 'en', text: 'Deadline reminders by email', included: true, sortOrder: 4 },
      { locale: 'en', text: 'Document archive', included: true, sortOrder: 5 },
      { locale: 'en', text: 'Client management', included: false, sortOrder: 6 },
    ],
  },
  {
    ...
    isActive: true,
    translations: {
      de: { locale: 'de', name: 'Monats-Flat', description: 'Unbegrenzte Einsprüche für Privatpersonen.', cta: 'Monat starten' },
      en: { locale: 'en', name: 'Monthly flat', description: 'Unlimited objections for individuals.', cta: 'Start monthly' },
    },
    features: [
      { locale: 'de', text: 'Unbegrenzte Einsprüche', included: true, sortOrder: 1 },
      { locale: 'de', text: 'Alle Bescheid-Typen', included: true, sortOrder: 2 },
      { locale: 'de', text: 'Frist-Erinnerungen', included: true, sortOrder: 3 },
      { locale: 'de', text: 'Dokumenten-Archiv', included: true, sortOrder: 4 },
      { locale: 'de', text: 'Mandanten-Verwaltung', included: false, sortOrder: 5 },
      { locale: 'en', text: 'Unlimited objections', included: true, sortOrder: 1 },
      { locale: 'en', text: 'All notice types', included: true, sortOrder: 2 },
      { locale: 'en', text: 'Deadline reminders', included: true, sortOrder: 3 },
      { locale: 'en', text: 'Document archive', included: true, sortOrder: 4 },
      { locale: 'en', text: 'Client management', included: false, sortOrder: 5 },
    ],
  },
  {
    slug: 'selfemployed-pack',
    userGroup: 'selfemployed',
    priceOnce: 19.99,
    priceMonthly: null,
    priceAnnual: null,
    currency: 'EUR',
    ...
    isActive: true,
    translations: {
      de: { locale: 'de', name: '5er-Paket SE', description: 'Für Freiberufler und Selbstständige.', cta: '5er-Paket kaufen' },
      en: { locale: 'en', name: '5-pack self-employed', description: 'For freelancers and the self-employed.', cta: 'Buy 5-pack' },
    },
    features: [
      { locale: 'de', text: '5 Einsprüche (kein Ablaufdatum)', included: true, sortOrder: 1 },
      { locale: 'de', text: 'Alle Bescheid-Typen inkl. Gewerbesteuer', included: true, sortOrder: 2 },
      { locale: 'de', text: 'Frist-Erinnerungen', included: true, sortOrder: 3 },
      { locale: 'de', text: 'Priorisierter Support', included: true, sortOrder: 4 },
      { locale: 'en', text: '5 objections (no expiry)', included: true, sortOrder: 1 },
      { locale: 'en', text: 'All notice types incl. trade tax', included: true, sortOrder: 2 },
      { locale: 'en', text: 'Deadline reminders', included: true, sortOrder: 3 },
      { locale: 'en', text: 'Priority support', included: true, sortOrder: 4 },
    ],
  },
  {
    slug: 'selfemployed-monthly',
    userGroup: 'selfemployed',
    priceOnce: null,
    priceMonthly: 19.99,
    priceAnnual: 199,
    ...
    isActive: true,
    translations: {
      de: { locale: 'de', name: 'SE-Flatrate', description: 'Unbegrenzte Nutzung für Selbstständige und Freiberufler.', cta: 'Flatrate starten' },
      en: { locale: 'en', name: 'SE Flatrate', description: 'Unlimited use for self-employed and freelancers.', cta: 'Start flatrate' },
    },
    features: [
      { locale: 'de', text: 'Unbegrenzte Einsprüche', included: true, sortOrder: 1 },
      { locale: 'de', text: 'Gewerbesteuer & Einkommensteuer', included: true, sortOrder: 2 },
      { locale: 'de', text: 'Frist-Erinnerungen + Kalender-Export', included: true, sortOrder: 3 },
      { locale: 'de', text: 'Priorisierter Support', included: true, sortOrder: 4 },
      { locale: 'en', text: 'Unlimited objections', included: true, sortOrder: 1 },
      { locale: 'en', text: 'Trade tax & income tax', included: true, sortOrder: 2 },
      { locale: 'en', text: 'Deadline reminders + calendar export', included: true, sortOrder: 3 },
      { locale: 'en', text: 'Priority support', included: true, sortOrder: 4 },
    ],
  },
  {
    slug: 'advisor-monthly',
    userGroup: 'advisor',
    priceOnce: null,
    priceMonthly: 49,
    priceAnnual: 490,
    ...
    isActive: true,
    translations: {
      de: { locale: 'de', name: 'Berater-Pro', description: 'Zentrales Einspruchs-Management für Steuerkanzleien.', cta: 'Berater-Zugang starten' },
      en: { locale: 'en', name: 'Advisor Pro', description: 'Central objection management for tax firms.', cta: 'Start advisor access' },
    },
    features: [
      { locale: 'de', text: 'Unbegrenzte Einsprüche für alle Mandanten', included: true, sortOrder: 1 },
      { locale: 'de', text: 'Multi-Mandanten-Dashboard', included: true, sortOrder: 2 },
      { locale: 'de', text: 'Bis zu 5 Nutzersitze', included: true, sortOrder: 3 },
      { locale: 'de', text: 'White-Label-Ausgabe', included: true, sortOrder: 4 },
      { locale: 'de', text: 'DATEV-Anbindung (Roadmap)', included: false, sortOrder: 5 },
      { locale: 'de', text: 'SLA 99,9 % + dedizierter Support', included: true, sortOrder: 6 },
      { locale: 'en', text: 'Unlimited objections for all clients', included: true, sortOrder: 1 },
      { locale: 'en', text: 'Multi-client dashboard', included: true, sortOrder: 2 },
      { locale: 'en', text: 'Up to 5 user seats', included: true, sortOrder: 3 },
      { locale: 'en', text: 'White-label output', included: true, sortOrder: 4 },
      { locale: 'en', text: 'DATEV integration (roadmap)', included: false, sortOrder: 5 },
      { locale: 'en', text: 'SLA 99.9% + dedicated support', included: true, sortOrder: 6 },
    ],
  },
  {
    slug: 'lawyer-monthly',
    ...
    isActive: true,
    translations: {
      de: { locale: 'de', name: 'Anwalts-Pro', description: 'Für Rechtsanwälte und Kanzleien mit Mandantenverwaltung.', cta: 'Anwalt-Zugang anfragen' },
      en: { locale: 'en', name: 'Lawyer Pro', description: 'For attorneys and law firms with case management.', cta: 'Request lawyer access' },
    },
    features: [
      { locale: 'de', text: 'Unbegrenzte Einsprüche', included: true, sortOrder: 1 },
      { locale: 'de', text: 'Alle Rechtsgebiete', included: true, sortOrder: 2 },
      { locale: 'de', text: 'Mandanten-Verwaltung', included: true, sortOrder: 3 },
      { locale: 'de', text: 'API-Zugang (REST)', included: true, sortOrder: 4 },
      { locale: 'de', text: 'Berufsgeheimnis-konform (beA-ready)', included: true, sortOrder: 5 },
      { locale: 'en', text: 'Unlimited objections', included: true, sortOrder: 1 },
      { locale: 'en', text: 'All legal areas', included: true, sortOrder: 2 },
      { locale: 'en', text: 'Client management', included: true, sortOrder: 3 },
      { locale: 'en', text: 'API access (REST)', included: true, sortOrder: 4 },
      { locale: 'en', text: 'Professional secrecy compliant (beA-ready)', included: true, sortOrder: 5 },
    ],
  },
]
