    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-[var(--muted)] mt-1">
          {role === 'ADMIN'
            ? 'System-Übersicht · alle Nutzer und Fälle'
        ...
        {role === 'ADMIN' && (
          ...
          >
            Admin-Panel öffnen <ArrowRight className="w-3 h-3" />
          </Link>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-5 mb-8">
        ...
        />
        <StatCard icon={CheckCircle2} label="Fälle gesamt" value={stats.total} iconClass="bg-purple-50 text-purple-600" />
      </div>
